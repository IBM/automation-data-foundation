output "gitops-cp4d-deployer_name" {
  description = "The name of the module"
  value = module.gitops-cp4d-deployer.name
}
output "gitops-cp4d-deployer_branch" {
  description = "The branch where the module config has been placed"
  value = module.gitops-cp4d-deployer.branch
}
output "gitops-cp4d-deployer_namespace" {
  description = "The namespace where the module will be deployed"
  value = module.gitops-cp4d-deployer.namespace
}
output "gitops-cp4d-deployer_server_name" {
  description = "The server where the module will be deployed"
  value = module.gitops-cp4d-deployer.server_name
}
output "gitops-cp4d-deployer_layer" {
  description = "The layer where the module is deployed"
  value = module.gitops-cp4d-deployer.layer
}
output "gitops-cp4d-deployer_type" {
  description = "The type of module where the module is deployed"
  value = module.gitops-cp4d-deployer.type
}
output "cloud_pak_deployer_namespace_name" {
  description = "Namespace name"
  value = module.cloud_pak_deployer_namespace.name
}
output "cpd_instance_namespace_name" {
  description = "Namespace name"
  value = module.cpd_instance_namespace.name
}
