output "gitops-global-pullsecret-synch_name" {
  description = "The name of the module"
  value = module.gitops-global-pullsecret-synch.name
}
output "gitops-global-pullsecret-synch_branch" {
  description = "The branch where the module config has been placed"
  value = module.gitops-global-pullsecret-synch.branch
}
output "gitops-global-pullsecret-synch_namespace" {
  description = "The namespace where the module will be deployed"
  value = module.gitops-global-pullsecret-synch.namespace
}
output "gitops-global-pullsecret-synch_server_name" {
  description = "The server where the module will be deployed"
  value = module.gitops-global-pullsecret-synch.server_name
}
output "gitops-global-pullsecret-synch_layer" {
  description = "The layer where the module is deployed"
  value = module.gitops-global-pullsecret-synch.layer
}
output "gitops-global-pullsecret-synch_type" {
  description = "The type of module where the module is deployed"
  value = module.gitops-global-pullsecret-synch.type
}
output "gitops-module-global-pullsecret_name" {
  description = "The name of the module"
  value = module.gitops-module-global-pullsecret.name
}
output "gitops-module-global-pullsecret_branch" {
  description = "The branch where the module config has been placed"
  value = module.gitops-module-global-pullsecret.branch
}
output "gitops-module-global-pullsecret_namespace" {
  description = "The namespace where the module will be deployed"
  value = module.gitops-module-global-pullsecret.namespace
}
output "gitops-module-global-pullsecret_server_name" {
  description = "The server where the module will be deployed"
  value = module.gitops-module-global-pullsecret.server_name
}
output "gitops-module-global-pullsecret_layer" {
  description = "The layer where the module is deployed"
  value = module.gitops-module-global-pullsecret.layer
}
output "gitops-module-global-pullsecret_type" {
  description = "The type of module where the module is deployed"
  value = module.gitops-module-global-pullsecret.type
}
output "entitlements_namespace_name" {
  description = "Namespace name"
  value = module.entitlements_namespace.name
}
